...
export const useRestaurandCard=({page,limit,search,city}:RestaurantCardRequestType)=>{
    return useQuery({
        queryKey:["restaurantCard",{page,limit,search,city}],
        queryFn:()=>RestaurantCardService({page:page,limit:limit,search:search,city:city}),
